...
Inspector และ Evidence จะแสดง Transaction Source เพื่อบอกแหล่งที่ใช้จริง
""",
    ),
    (
        "33. Folder Grouping",
...
""",
    ...
    (
        "36. Raw Export Confirmation",
        """
Raw log files ไม่ผ่าน Sensitive-data masking และปิดเป็นค่าเริ่มต้น เมื่อเปิดตัวเลือกนี้
Evidence page จะแสดงคำเตือน และเมื่อกด Export โปรแกรมจะถามยืนยันพร้อมจำนวนไฟล์
อีกครั้ง ถ้ากด Cancel จะยังไม่มีการสร้างโฟลเดอร์ ZIP หรือไฟล์ Export

ควรใช้ Sanitized log files เป็นหลัก และเปิด Raw เฉพาะเมื่อผู้รับหลักฐานได้รับอนุญาต
...
""",
    ...
    (
        "45. Find in Evidence Preview",
        """
หน้า Evidence มีช่อง Find in evidence สำหรับค้นหาข้อความภายใน Included evidence
